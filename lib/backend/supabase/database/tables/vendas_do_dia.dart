...
class VendasDoDiaTable extends SupabaseTable<VendasDoDiaRow> {
  @override
  String get tableName => 'vendas_do_dia';

  @override
  VendasDoDiaRow createRow(Map<String, dynamic> data) => VendasDoDiaRow(data);
}

class VendasDoDiaRow extends SupabaseDataRow {
  VendasDoDiaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VendasDoDiaTable();
